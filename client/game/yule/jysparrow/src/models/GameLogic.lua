...
GameLogic.CHR_SI_AN_KE				=0x00100000							--//四 暗 刻
GameLogic.CHR_LUO_HAN				=0x00200000							--//十八罗汉	
GameLogic.CHR_SHI_SAN_YAO			=0x00400000							--//十三幺
GameLogic.CHR_SP_QI_DUI				=0x00800000							--豪华七对
GameLogic.CHR_SP_D_QI_DUI			=0x01000000							--双豪华七对
GameLogic.CHR_SP_T_QI_DUI			=0x02000000							--三豪华七对
GameLogic.CHR_YI_JIU_HU				=0x04000000                         --一九胡
GameLogic.CHR_QING_YI_JIU			=0x08000000							--清一九
...
{
	{chr = GameLogic.CHR_PING_HU,				str="平胡", 				 group=1, 						fan=1},
	{chr = GameLogic.CHR_QIANG_GANG_HU,			str="抢杠胡", 			    group=2, 						fan=2},
	{chr = GameLogic.CHR_PENG_PENG,				str="碰碰胡", 			    group=3, 		priority=1, 	fan=2},
	{chr = GameLogic.CHR_QI_DUI,				str="七对", 				 group=4, 		priority=1, 	fan=2},
	{chr = GameLogic.CHR_TIAN_HU,				str="天胡",				 group=5, 						fan=10},
	{chr = GameLogic.CHR_DI_HU,					str="地胡", 				 group=6, 						fan=10},
	{chr = GameLogic.CHR_QING_YI_SE,			str="清一色", 				group=7, 						fan=2},
	{chr = GameLogic.CHR_HUN_YI_SE,				str="混一色", 				group=8, 						fan=2},
	{chr = GameLogic.CHR_SHI_SAN_YAO,			str="十三幺", 				group=9, 						fan=10},
	{chr = GameLogic.CHR_ZI_YI_SE,				str="字一色", 				group=10, 		priority=1, 	fan=4},
	{chr = GameLogic.CHR_XIAO_SAN_YUAN,			str="小三元", 				group=11, 		priority=1, 	fan=4},
	{chr = GameLogic.CHR_DA_SAN_YUAN,			str="大三元",				group=11, 		priority=2, 	fan=6},
	{chr = GameLogic.CHR_XIAO_SI_XI,			str="小四喜",				group=12, 		priority=1, 	fan=4},
	{chr = GameLogic.CHR_DA_SI_XI,				str="大四喜", 				group=12, 		priority=2, 	fan=6},
	{chr = GameLogic.CHR_LUO_HAN,				str="十八罗汉", 		   group=3, 		priority=2, 	fan=10},
	{chr = GameLogic.CHR_SP_QI_DUI,				str="豪华七对", 		   group=4, 		priority=2, 	fan=4},
	{chr = GameLogic.CHR_SP_D_QI_DUI,			str="双豪华七对", 		  group=4, 			priority=3, 	fan=6},
	{chr = GameLogic.CHR_SP_T_QI_DUI,			str="三豪华七对", 		  group=4, 			priority=4, 	fan=8},
	{chr = GameLogic.CHR_YI_JIU_HU,				str="一九胡", 				group=10, 		priority=2, 	fan=4},
	{chr = GameLogic.CHR_QING_YI_JIU,			str="清一九",				group=10, 		priority=3, 	fan=10},
	{chr = GameLogic.CHR_GANG_SHANG_HUA,		str="杠上花",				group=13, 		priority=1, 	fan=2},
}
	
GameLogic.LocalChiHuRightRes =
{
    [GameLogic.CHR_PENG_PENG]         	= "shareResult/fenxiang-font-04.png",
    [GameLogic.CHR_QI_DUI] 				= "shareResult/fenxiang-font-07.png", 
	[GameLogic.CHR_TIAN_HU]				= "shareResult/fenxiang-font-21.png",	
	[GameLogic.CHR_DI_HU]				= "shareResult/fenxiang-font-20.png",
	[GameLogic.CHR_QING_YI_SE]			= "shareResult/fenxiang-font-05.png",
	[GameLogic.CHR_HUN_YI_SE]			= "shareResult/fenxiang-font-06.png", 
	[GameLogic.CHR_SHI_SAN_YAO]			= "shareResult/fenxiang-font-14.png", 
	[GameLogic.CHR_ZI_YI_SE]			= "shareResult/fenxiang-font-13.png",
	[GameLogic.CHR_XIAO_SAN_YUAN]		= "shareResult/fenxiang-font-16.png",
	[GameLogic.CHR_DA_SAN_YUAN]			= "shareResult/fenxiang-font-17.png",	
	[GameLogic.CHR_XIAO_SI_XI]			= "shareResult/fenxiang-font-18.png",	
	[GameLogic.CHR_DA_SI_XI]			= "shareResult/fenxiang-font-19.png", 	
	[GameLogic.CHR_LUO_HAN]				= "shareResult/fenxiang-font-15.png", 
	[GameLogic.CHR_SP_QI_DUI]			= "shareResult/fenxiang-font-08.png", 
	[GameLogic.CHR_SP_D_QI_DUI]			= "shareResult/fenxiang-font-09.png", 
	[GameLogic.CHR_SP_T_QI_DUI]			= "shareResult/fenxiang-font-10.png", 	
	[GameLogic.CHR_YI_JIU_HU]			= "shareResult/fenxiang-font-11.png", 
	[GameLogic.CHR_QING_YI_JIU]			= "shareResult/fenxiang-font-12.png",
}
...
function GameLogic.getChiHuRightInfo(rightData)
	...
	local targets = {}
	for i=1, #GameLogic.LocalChiHuRight do
		local Right = GameLogic.LocalChiHuRight[i]
		
		local bExistGroup = false
		local nExistIdx = 0

		for j=1, #targets do
			if targets[j].group == Right.group then
				bExistGroup = true
				nExistIdx = j
			end
		end

		for j=1, #rightData do
			if rightData[j] ~= 0 and bit:_and(Right.chr, rightData[j]) ~= GameLogic.WIK_NULL then
				if bExistGroup == false then
					targets[#targets + 1] = Right
				else
					targets[nExistIdx] = Right
				end
			end
		end
	end
	...
	-- 平胡 跟其他牌型互斥
	if #targets > 1 then
		if targets[1].chr == GameLogic.CHR_PING_HU then
	...
	num = #targets
	for i=1, num do
		stringTable[i] = targets[i].str .. string.format('×%d倍', targets[i].fan)
		fan[i] = targets[i].fan
	end
