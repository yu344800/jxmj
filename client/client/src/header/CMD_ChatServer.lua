...
chat_cmd.SUB_GC_QUERY_USER_TITLE		= 500							--查询头号
chat_cmd.SUB_GC_GET_USER_TITLE			= 501							--返回头号
---------------
------数据长度
---------------
...
--查询头号
chat_cmd.CMD_GC_QueryUserTitle =
{
	{t = "dword",	k = "dwKindID"},									--游戏类型
	{t = "dword",	k = "dwUserID"},									--用户ID
}

chat_cmd.CMD_GC_UserTitle =
{
	{t = "dword", k = "dwUserID"},
	{t = "score",	k = "lKindScore"},--称号积分
}
