...
-- 分享操作
login.SUB_GP_QUERY_SHARE_AWARD_COUNT	= 400								--查询分享剩余次数
login.SUB_GP_QUERY_SHARE_AWARD_COUNT_RESULT	= 401							--分享剩余次数结果
login.SUB_GP_GET_SHARE_AWARD			= 402								--领取分享奖励
...
-- 分享结果
login.CMD_GP_ShareAwardCount = {
	--剩余次数
	{k = "bCount", t = "byte"},
	--提示内容
	{k = "szNotifyContent", t = "string", s = 128}
}
-----------------------------
...
login.CMD_GP_CheckInInfo = {
	{k = "wSeriesDate", t = "word"},
	{k = "bTodayChecked", t = "bool"},
	{k = "bMonthChecked", t = "byte",l={31}},
