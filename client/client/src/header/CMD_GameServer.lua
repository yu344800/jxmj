...
--回包结构
--旁观请求
game_cmd.CMD_GR_UserLookon =
{
	{k = "wTableID", t = "word"},									--桌子位置
	{k = "wChairID", t = "word"}									--椅子位置
}
--请求失败
...
game_cmd.SUB_GF_USER_EXPRESSION_MAGIC 	= 13									--魔法表情
