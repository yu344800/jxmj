...
login.SUB_MB_QUERY_GAME_SERVER = 204                                    -- 搜索房间
login.SUB_MB_QUERY_GAME_SERVER_RESULT = 205                             -- 搜索结果
...
login.SUB_MB_SCORE_EXCHANGE_TO_ROOM_CARD = 223                          -- 金币兑换房卡
------
-- 消息结构
------
-- 创建房间
...
-- 金币兑换房卡
login.CMD_GP_ExchangRoomCardByScore = 
{
    -- 用户标识
    {t = "dword", k = "dwUserID"},
    -- 房卡数量
...
game.SUB_GR_REQUEST_STATUS = 12                                         -- 解散状态
...
--请求解散 状态
game.CMD_GR_CancelRequestStatus = 
{
    {t = "table", k = "CancelRequest", d=game.CMD_GR_CancelRequest},
    {t = "dword", k = "CancelRequestTime"}              -- 请求时间
}
