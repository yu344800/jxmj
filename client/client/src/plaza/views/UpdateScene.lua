...
function UpdateScene:onCreate( )
    ...
    --背景
    local newbasepath = device.writablePath .. "/baseupdate/"
    ...
    total_bg:setPosition(appdf.WIDTH/2, 90)
    ...
    self.m_totalBar:setPosition(appdf.WIDTH/2, 90)
    ...
    --版本号
    self.verTips = cc.Label:createWithTTF("", "fonts/round_body.ttf", 24)
        :setTextColor(cc.c4b(234, 255, 255, 255))
        :enableOutline(cc.c4b(0, 0, 0, 255), 2)
        :move(display.width - 100, 40)
        :addTo(self)
...
function UpdateScene:updateBar(bar, thumb, percent)
    ...
    thumb:setPositionX(size.width * percent / 100 - 15)
end
