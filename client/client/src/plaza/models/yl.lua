...
-- HTTP请求地址
yl.HTTP_URL_LIST = {
	"http://192.168.2.138:8080",
	"http://120.78.147.74:8080",
	"http://47.96.90.32:8080",--线上地址
	"http://192.168.2.165:8080",
}


-- 登陆地址
yl.LOGONSERVER						    = "47.96.90.32"	--线上服
yl.HTTP_URL								= "http://47.96.90.32:8080"	--线上服
-- yl.LOGONSERVER                          = "192.168.2.138" --@login_ip
-- yl.HTTP_URL								= "http://192.168.2.138:8080" --@http_url
...
yl.SCENE_HOT_GAMELIST					= 35		-- 热门游戏
yl.SCENE_PLAYBACK						= 36		--游戏回放
...
yl.LEN_MATCH_GAME_SERVER_ITEM			= 672			--比赛房间长度
...
yl.SocialShare =
{
	...
	url 								= yl.HTTP_URL,
	AppKey							 	= "59f03ef7f43e480707000044", --@share_appkey_social
}
...
yl.WeChat = 
{
	AppID 								= "wx9cb029e7c0ef5d35", --@wechat_appid_wx
	AppSecret 							= "f97d97307929bb4d42dd8f545e9ab91b", --@wechat_secret_wx
	-- 商户id
