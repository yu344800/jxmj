...
--设置Base资源版本
function Version:setBaseResVersion(version)
	self._versionInfo["base"] = version
end

--获取Base资源版本
function Version:getBaseResVersion(version)
	return self._versionInfo["base"]
end

--设置cmd资源版本
function Version:setCmdVersion(version)
	self._versionInfo["cmd"] = version
end

--获取cmd资源版本
function Version:getCmdVersion(version)
	return self._versionInfo["cmd"]
end
